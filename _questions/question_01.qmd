...
* Association ≠ proof: More bids often correlate with higher prices, but counterexamples are common.
* "Suggestive" vs "confirmatory": Patterns like high num_bids with low final_price, or high final_price with few bids, are flags—not verdicts.
...
"winner_id is missing—name one data reason and one market reason."

"If you could request two extra fields to investigate shilling, what would they be and why?"

📌 **Common Misunderstandings**

"More bids must mean higher price." → Often, but not always; commodities, ceilings, or reserve mechanics can flatten prices.

Treating outliers as proof of shilling. → They are review candidates only.

Using means on skewed data. → Prefer medians/quantiles; acknowledge skew explicitly in commentary.
...
So for 1(d): I’d cite (i) the heap at 15 bids, and (ii) high-bid-count auctions that still close near the lower half of prices as suggestive (not proof).
